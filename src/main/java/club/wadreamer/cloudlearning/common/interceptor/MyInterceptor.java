package club.wadreamer.cloudlearning.common.interceptor;
...
//import club.wadreamer.videos.model.auto.InterUrl;
//import club.wadreamer.videos.model.auto.InterUrlExample;
...
public class MyInterceptor implements HandlerInterceptor {
	...
	/*************演示模式需要 start*************/
	/**需要被拦截的post请求url**/
//	public static List<InterUrl> posturllist=new ArrayList<InterUrl>();
	/**需要被拦截的get请求url**/
//	public static List<InterUrl> geturllist=new ArrayList<InterUrl>();
	/**注入拦截器表的service**/
...
//	}
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object arg2) throws Exception {
		//设置前端的全局地址，如果前端网页错乱请修改这儿
		request.setAttribute("rootPath", request.getContextPath());
		request.setAttribute("projectName","基于云计算的在线视频学习平台");
